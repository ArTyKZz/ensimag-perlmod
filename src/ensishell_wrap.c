...
#define SWIG_init    boot_ensishell

#define SWIG_name   "ensishellc::boot_ensishell"
#define SWIG_prefix "ensishellc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_ensishell_var::
class _wrap_ensishell_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_executer) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: executer(char *);");
    }
    res1 = SWIG_AsCharPtrAndSize(ST(0), &buf1, NULL, &alloc1);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "executer" "', argument " "1"" of type '" "char *""'");
    }
    arg1 = (char *)(buf1);
    result = (int)executer(arg1);
...
{"ensishellc::executer", _wrap_executer},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
